! function o(a, s, c) {
    ...
    2: [function(M, t, e) {
        ...
        ! function() {
            ...
            function z() {
                var t = Date.now();
                e || H({ time: t, id: 111111111211, name: "SYSTEM", msg: "您已掉线，点‘囧’重连..." }), O([]), clearInterval(a)
            }
